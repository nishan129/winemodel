...
from src.entity.config_entity import ModelEvauationConfig
from src.entity.artifact_entity import ModelTrainerArtifact,DataValidationArtifact, ModelEvaluationArtifact
import sys
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            if self.model_eval_config.changed_thredsold < improved_accuracy:
                #0.02 < 0.03
                is_model_accepted=True
            else:
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                    is_model_accepted=is_model_accepted, 
                    imporved_accuracy=improved_accuracy, 
